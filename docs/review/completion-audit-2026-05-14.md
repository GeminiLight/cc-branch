...
| 补 Python 静态类型质量门槛 | `pyproject.toml`、`.github/workflows/ci.yml`、`cc_branch/*` | 已推进：`dev` extra 增加 `mypy` 和 `types-PyYAML`；CI 增加 Python typecheck job；当前 `cc_branch` 150 个源码文件通过本机、Linux platform 和 Windows platform mypy。 |
