const translations = {
  en: {
    pageTitle: "CC Branch - Restore AI workspaces from config",
    description:
      "CC Branch restores AI development workspaces from committed config: tmux sessions, agent panes, local apps, SSH panes, Web UI, and desktop control.",
    ogDescription:
      "A CLI-first workspace orchestrator that restores agents, terminals, editors, dev servers, and remote panes from one project config.",
    ...
    navInstall: "Install",
    navDocs: "Docs",
    heroEyebrow: "CC Branch for terminal AI workflows",
    heroTitle: "Restore your AI workspace in one command.",
    heroCopy:
      "Define tabs, panes, agents, commands, editors, and remote targets once. CC Branch brings them back as reusable sessions whenever you return to the repo.",
    heroPrimary: "Install and try it",
    ...
    heroPoint1: "One config committed with the project",
    heroPoint2: "Tmux sessions, agents, local apps, and SSH panes restore together",
    heroPoint3: "CLI, Web UI, and desktop app share the same model",
    capability1Kicker: "Define",
    capability1Title: "Describe the workspace once.",
    capability1Body:
      "Tabs, panes, agents, commands, directories, env vars, openers, and remote targets live in one YAML file.",
    capability2Kicker: "Preview",
    capability2Title: "Know what will launch before it runs.",
    capability2Body:
      "`cc-branch plan` resolves tmux sessions, direct commands, SSH panes, and agent resume commands.",
    capability3Kicker: "Restore",
    capability3Title: "Bring the room back.",
    capability3Body:
      "Start, attach, restart, stop, and prune long-running workspace sessions from one CLI.",
    capability4Kicker: "Inspect",
    capability4Title: "See and fix drift.",
    capability4Body:
      "Doctor checks commands, tmux, paths, agent references, session IDs, and safe auto-fixes.",
  ...
  zh: {
    pageTitle: "CC Branch - 从配置恢复 AI 工作空间",
    description:
      "CC Branch 从已提交的配置恢复 AI 开发工作空间：tmux 会话、Agent 窗格、本地应用、SSH 窗格、Web UI 和桌面端控制。",
    ogDescription:
      "一个 CLI-first 工作空间编排器，用一份项目配置恢复 Agent、终端、编辑器、开发服务和远程窗格。",
    skip: "跳到正文",
    navWhy: "为什么",
    navDesktop: "桌面端",
    navWorkflow: "工作流",
    navInstall: "安装",
    navDocs: "文档",
    heroEyebrow: "面向终端 AI 工作流的 CC Branch",
    heroTitle: "一条命令恢复你的 AI 工作空间。",
    heroCopy:
      "把 tabs、panes、Agent、命令、编辑器和远程目标定义一次。回到仓库时，CC Branch 会把它们作为可复用会话带回来。",
    heroPrimary: "安装并试用",
    heroSecondary: "查看工作流",
    heroPanelLabel: "恢复预览",
    ...
    heroPoint1: "一份配置随项目提交",
    heroPoint2: "tmux 会话、Agent、本地应用和 SSH 窗格一起恢复",
    heroPoint3: "CLI、Web UI 和桌面端共用同一套模型",
    capability1Kicker: "定义",
    capability1Title: "只描述一次工作空间。",
    capability1Body:
      "Tabs、panes、Agent、命令、目录、环境变量、打开方式和远程目标都在一份 YAML 里。",
    capability2Kicker: "预览",
    capability2Title: "启动前先知道会发生什么。",
    capability2Body:
      "`cc-branch plan` 会解析 tmux 会话、direct 命令、SSH 窗格和 Agent 恢复命令。",
    capability3Kicker: "恢复",
    capability3Title: "把现场带回来。",
    capability3Body:
      "用同一个 CLI start、attach、restart、stop 和 prune 长期工作空间会话。",
    capability4Kicker: "检查",
    capability4Title: "看见并修复漂移。",
    capability4Body:
      "Doctor 检查命令、tmux、路径、Agent 引用、session_id 和低风险自动修复。",
    whyKicker: "本地控制问题",
