...
### `scenario-ssh-remote.yaml`

Best for:

- running selected panes on a server or GPU box
- keeping local editor/control panes next to remote execution panes
- sharing SSH defaults at tab level while overriding a pane's remote `cwd`
