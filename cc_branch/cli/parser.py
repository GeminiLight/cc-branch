...
def _add_snapshot_group(subparsers: argparse._SubParsersAction) -> None:
    ...
    create_cmd.add_argument("--include-files", action="store_true", help="also capture restorable workspace file contents")
    ...
    restore_cmd.add_argument("--state-only", action="store_true", help="restore state metadata without restoring captured files")
