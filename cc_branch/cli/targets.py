...
def print_targets_help() -> None:
    ...
    console.print()
    console.print("Use targets to select a workspace, tab, or pane.")
    console.print()
    ...
    table.add_row("dev", "tab named dev")
    table.add_row("dev:planner", "pane named planner in tab dev")
    table.add_row("dev.planner", "internal key form for dev:planner")
    console.print(table)
    console.print()
