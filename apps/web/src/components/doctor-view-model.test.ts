...
function t(key: string, vars?: Record<string, string | number>): string {
  const messages: Record<string, string> = {
    ...
    runtimeChangedPendingOne: "{count} changed",
    runtimeMissingPending: "{count} missing",
    runtimeMissingPendingOne: "{count} missing",
    runtimeUntracked: "{count} untracked",
    runtimeUntrackedOne: "{count} untracked",
    runtimeExtraPanes: "{count} extra",
    runtimeExtraPanesOne: "{count} extra",
    runtimeOrphanedState: "{count} orphaned",
    runtimeOrphanedStateOne: "{count} orphaned",
