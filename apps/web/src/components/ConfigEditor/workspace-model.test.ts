...
describe("workspace model", () => {
  ...
  it("splits a tmux-backed tab into a movable tmux group plus a new pane", () => {
    const mutation = addPaneMutation([
      slotConfig({
        name: "tmux-dev",
        runtime: "tmux",
  ...
  it("adds a second tmux group next to a tmux-backed tab group", () => {
    const mutation = addTmuxGroupPaneMutation([
      slotConfig({
        name: "agents",
        runtime: "tmux",
  ...
  it("updates a tmux window inside a tmux-backed tab", () => {
  ...
  it("adds a tmux window to an empty tmux-backed tab without losing the original launch fields", () => {
    const mutation = addTmuxWindowMutation([
      slotConfig({
        name: "agent",
        runtime: "tmux",
  ...
  it("treats tmux-backed slots as one outer pane regardless of internal windows", () => {
    ...
    expect(isTmuxBackedTab(slot)).toBe(true);
  ...
  it("counts explicit tmux groups as panes without counting their internal windows", () => {
    ...
    expect(isTmuxBackedTab(slot)).toBe(false);
  ...
  it("projects a tmux-backed tab as one canvas pane with internal windows hidden", () => {
    const slot = slotConfig({
      name: "dev",
      runtime: "tmux",
      windows: [
  ...
  it("wraps tmux-backed tabs as movable tmux group windows", () => {
    const slot = slotConfig({
      name: "dev",
      runtime: "tmux",
      cwd: "app",
  ...
  it("preserves slot-level launch fields when wrapping an empty tmux-backed tab", () => {
    const slot = slotConfig({
      name: "agent",
      runtime: "tmux",
      agent: "codex",
  ...
  it("turns a tmux-backed tab into a movable tmux group when dropped into another tab", () => {
    const slots = [
      slotConfig({
        name: "tmux-dev",
        runtime: "tmux",
  ...
  it("rejects invalid tmux-backed group source pane indexes", () => {
    const slots = [
      slotConfig({
        name: "tmux-dev",
        runtime: "tmux",
