...
type WorkspaceCanvasProps = {
  ...
  onTogglePaneEnabled: (slotIndex: number, windowIndex: number | null) => void;
                        ...
                        {canvasPanes.map((pane, paneIndex) => {
                          ...
                          return (
                            ...
                            <div
                              ...
                              } ${paneEnabled ? "" : "opacity-60 grayscale-[0.25]"} ${paneIsDragSource ? "opacity-55 scale-[0.99]" : ""} ${
                            ...
                            >
                              ...
                              <span className="relative flex items-start justify-between gap-2 pl-1.5">
                                ...
                                <span className="flex shrink-0 items-center gap-1.5">
                                  {!paneEnabled && (
                                    <span className="inline-flex h-5 items-center gap-1 rounded border border-default bg-[var(--bg-hover)] px-1.5 text-[10px] font-semibold text-tertiary">
