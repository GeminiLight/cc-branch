              ...
              <div>
                ...
                <SelectInput
                  ...
                  options={[
                    ...
                    { value: "cursor", label: "Cursor", icon: <OpenerMark openerId="cursor" label="Cursor" compact /> },
                    { value: "vscode", label: "VS Code", icon: <OpenerMark openerId="vscode" label="VS Code" compact /> },
                    { value: "warp", label: "Warp", icon: <OpenerMark openerId="warp" label="Warp" compact /> },
                    { value: "terminal-app", label: "Terminal.app", icon: <OpenerMark openerId="terminal-app" label="Terminal.app" compact /> },
                    { value: "iterm2", label: "iTerm2", icon: <OpenerMark openerId="iterm2" label="iTerm2" compact /> },
                    { value: "auto-terminal", label: t("systemTerminal"), icon: <OpenerMark openerId="auto-terminal" label={t("systemTerminal")} compact /> },
                  ]}
                />
              </div>
              <div>
